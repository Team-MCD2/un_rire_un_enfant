  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[calc(6rem+env(safe-area-inset-bottom,0px))] left-4 z-[60] w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center hover:scale-105 active:scale-95 transition-transform"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[calc(10rem+env(safe-area-inset-bottom,0px))] left-4 z-[60] w-[calc(100vw-2rem)] max-w-sm bg-card rounded-2xl shadow-2xl border border-border flex flex-col overflow-hidden"
